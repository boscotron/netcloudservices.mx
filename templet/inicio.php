...
<div class="jmy_web_slider"   data-page="inicio" data-tabla="vistaweb"   id="marco_principal"  data-marco="marco_principal" data-var='<?php echo json_encode([ [ 
            ...
            <div class="et_pb_column et_pb_column_4_4  et_pb_column_0 et_pb_css_mix_blend_mode_passthrough et-last-child">
               <div class="et_pb_text et_pb_module et_pb_bg_layout_dark et_pb_text_align_left  et_pb_text_0">
                  <div class="et_pb_text_inner">
                     <h1 class="jmy_web_div" data-page="<?php echo $page; ?>" id="titulo_inicio" data-editor="no"><?php $this->pnt('titulo_inicio','<br><strong >SOLUCIONES TECNOLÓGICAS</strong>'); ?>	</h1>
      ...
      <div id="netcloud" class="et_pb_section et_pb_section_1 et_section_regular et_section_transparent">
         <div class=" et_pb_row et_pb_row_1">
            ...
            <div class="et_pb_column et_pb_column_1_3  et_pb_column_3 et_pb_css_mix_blend_mode_passthrough et-last-child">
				<div class="jmy_web_slider"  data-page="<?php echo $page; ?>"   data-tabla="vistaweb"  id="marco_imagen_top_blog"  data-marco="marco_imagen_top_blog" data-var='<?php echo json_encode([ [ 
					"type"=>"imagen",
					"id"=>"imagen_top_blog",
         ...
         <div class=" et_pb_row et_pb_row_2">
            <div class="et_pb_column et_pb_column_1_2  et_pb_column_4 et_pb_css_mix_blend_mode_passthrough">
               <div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left  et_pb_text_1">
                  <div class="et_pb_text_inner jmy_web_div" data-page="<?php echo $page; ?>" id="nosotros_desc_1" data-editor="on"><?php $this->pnt('nosotros_desc_1','<p>En <strong>Netcloud Services</strong> avanzamos junto con la tecnología, <strong>contamos con la capacidad de ejecución y experiencia técnica para implantar tecnologías innovadoras</strong> y mantener un alto nivel de calidad en el servicio al cliente, porque sabemos que contar con las herramientas&nbsp; adecuadas en las empresas tiene un impacto directo y tangible en los negocios.&nbsp;&nbsp;Diseñamos e implementamos estrategias tecnologicas a la medida para que las <strong>empresas optimicen sus procesos y potencialicen sus servicios.&nbsp;</strong></p>'); ?></div>
               </div>
               <!-- .et_pb_text -->
            </div>
            <!-- .et_pb_column -->
            <div class="et_pb_column et_pb_column_1_2  et_pb_column_5 et_pb_css_mix_blend_mode_passthrough et-last-child">
               <div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left  et_pb_text_2">
                  <div class="et_pb_text_inner jmy_web_div" data-page="<?php echo $page; ?>" id="nosotros_desc_2" data-editor="on"><?php $this->pnt('nosotros_desc_2',' <p><strong>Nos adaptamos a las necesidades de cada organización</strong> para brindarles las mejores soluciones&nbsp;a través de marcas líderes en el ramo.&nbsp;Estar aliados con empresas tecnológicas <strong>nos mantiene a la vanguardia</strong> y nos ayuda a ofrecer soluciones de servicio.</p>'); ?></div>
               </div>
               <!-- .et_pb_text -->
            </div>
            <!-- .et_pb_column -->
      ...
      <div id="servicios" class="et_pb_section et_pb_section_3 et_section_regular">
		 ...
		 <div class="jmy_web_contador" data-page="<?php echo $page; ?>" id="cuadros_inicio" data-value="<?php echo $cuadros; ?>" data-titulo="Número de cuadros "></div>
         ...
         <div class=" et_pb_row et_pb_row_6 et_pb_gutters2">
            ...
            <div class="et_pb_column et_pb_column_1_2  et_pb_column_15 et_pb_css_mix_blend_mode_passthrough et-last-child">
               <div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_left  et_pb_text_11">
                  <div class="et_pb_text_inner">
                     <h2 class="jmy_web_div" data-page="<?php echo $page; ?>" id="contacto_titulo" data-editor="no"><?php $this->pnt('contacto_titulo','<b>¡TE ESTAMOS&nbsp;</b><span style="color: #00aeef;"><strong>BUSCANDO!</strong></span>'); ?></h2>
                     <p class="jmy_web_div" data-page="<?php echo $page; ?>" id="contacto_descripcion" data-editor="no"><?php $this->pnt('contacto_descripcion',' Desarrollamos aplicaciones móviles con ingenio e inteligencia para impulsar el uso de la tecnología de gran impacto con relevancia educativa, empresarial y social. Buscamos jovenes apasionados de la tecnología y con experiencia en programación.'); ?></p>
                     <h2 class="jmy_web_div" data-page="<?php echo $page; ?>" id="contacto_h2" data-editor="no"><?php $this->pnt('contacto_h2','<span style="color: #00aeef;"><strong>ÚNETE A NUESTRO EQUIPO</strong></span>'); ?></h2>
                  </div>
               </div>
               <!-- .et_pb_text -->
