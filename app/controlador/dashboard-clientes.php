    ...
    if($peticiones[0]!=""){
        ...
        if($session['body']['api_web']['ID_F']!=''){
            $info_cliente = $jmy->ver([
                    "TABLA"=>$config['tabla_clientes']."_".$session['body']['api_web']['ID_F'],
                    //"COL"=>["url"],
                    //"V"=>[$peticiones[1]],
                    "ID"=>[$peticiones[0]],
                ]);
        ...
        switch ($url) {
            ...
            case 'notas':
                ...
                $out = $jmyWeb->cargar(["pagina"=>$peticiones[1],
                                        "tabla"=>$config['tabla_notas'].'_'.$session['body']['api_web']['ID_F'],
                                        ]);
            ...
            case 'cotizaciones':
                ...
                if($idsVer[1]=='copiar'){ 
                    ...
                    $copiar['ver']=$jmy->ver([
                        "TABLA"=>$config['tabla_cotizaciones'].'_'.$session['body']['api_web']['ID_F'],
                        "ID_F"=>[$idVer],
                        "SALIDA"=>"ARRAY",
                    ]);
                ...
                $url_redirect=$jmyWeb->url_inicio(['return'=>true]).'dashboard-clientes/cotizaciones/'.$info_cliente_key.'/'.$idVer;
               ...
               $jmyWeb->cargar_css(['url'=>$jmyWeb->url_templet(['return'=>true]).'assets/css/cotizaciones.css','unico'=>true]);
                $jmyWeb->cargar_vista([
                    "url"=>"detalle_cliente-cotizaciones.php",
                    "data"=>[ 
                        "animacion"=>true,
                        "peticiones"=>$peticiones,
                        "editor"=>$editor,
            ...
            case 'proyectos':
                ...
                if($idsVer[1]=='copiar'){ 
                    ...
                    $copiar['ver']=$jmy->ver([
                        "TABLA"=>$config['tabla_proyectos'].'_'.$session['body']['api_web']['ID_F'],
                        "ID_F"=>[$idVer],
                        "SALIDA"=>"ARRAY",
                    ]);
                   // $jmyWeb ->pre(['p'=>$copiar['ver']['otFm'][0],'t'=>'TITULO_ARRAY']);
                ...
                $url_redirect=$jmyWeb->url_inicio(['return'=>true]).'dashboard-clientes/proyectos/'.$info_cliente_key.'/'.$idVer;
               ...
               $jmyWeb->cargar_css(['url'=>'https://cdnjs.cloudflare.com/ajax/libs/vis/4.21.0/vis.min.css','unico'=>true]);
                $jmyWeb->cargar_vista([
                    "url"=>"detalle_cliente-proyectos.php",
                    "data"=>[ 
                        "animacion"=>true,
                        "peticiones"=>$peticiones,
                        "editor"=>$editor,
            ...
            case 'presentaciones':
                ...
                if($idsVer[1]=='copiar'){ 
                    ...
                    $copiar['ver']=$jmy->ver([
                        "TABLA"=>$config['tabla_presentaciones'].'_'.$session['body']['api_web']['ID_F'],
                        "ID_F"=>[$idVer],
                        "SALIDA"=>"ARRAY",
                    ]);
                   // $jmyWeb ->pre(['p'=>$copiar['ver']['otFm'][0],'t'=>'TITULO_ARRAY']);
                ...
                $url_redirect=$jmyWeb->url_inicio(['return'=>true]).'dashboard-clientes/presentaciones/'.$info_cliente_key.'/'.$idVer;
               ...
               $jmyWeb->cargar_css(['url'=>'templet/assets/css/presentaciones.css','unico'=>true]);
                ...
                $jmyWeb->cargar_vista([
                    "url"=>"detalle_cliente-presentaciones.php",
                    "data"=>[ 
                        "animacion"=>true,
                        "peticiones"=>$peticiones,
                        "editor"=>$editor,
            ...
            //$jmyWeb ->pre(['p'=>$url,'t'=>'TITULO_ARRAY']);
